...
public class MyReservationAdapter extends RecyclerView.Adapter<MyReservationAdapter.ViewHolder>  {
    ...
    public MyReservationAdapter(ArrayList<Booking> dataBooking, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = layoutInflater.inflate(R.layout.list_item_reservation, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tvPeople.setText("・"+dataBooking.get(position).getSumOfPeople()+" orang");
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            //    Toast.makeText(context, holder.tvOutlet.getText(), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(context, DetailReservationItem.class);
                Bundle b = new Bundle();
                ...
                intent.putExtras(b);
              //  Toast.makeText(context, "adapter "+dataBooking.get(position).getIdBooking(), Toast.LENGTH_SHORT).show();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvOutlet, tvGuest, tvPeople, tvDates, tvTimes, tvStatus;
        String strIdStore;
