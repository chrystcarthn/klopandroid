...
public class BookTreatmentAdapter extends RecyclerView.Adapter<BookTreatmentAdapter.ViewHolder> {

    private ArrayList<Treatment> dataTreatments;
    private Context context;

    public BookTreatmentAdapter(ArrayList<Treatment> dataTreatments, Context context) {
