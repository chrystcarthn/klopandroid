...
public class StoreAdapter extends RecyclerView.Adapter<StoreAdapter.ViewHolder> {
    ...
    public StoreAdapter(ArrayList<Store> dataStore, Context context) {
...
//    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(dataStore.get(position).getDistanceKilo() != null){
            jarak = String.format("%.01f", Float.valueOf(dataStore.get(position).getDistanceKilo()))
                    .replace(",",".")
                    .replace(",00","")
                    .replace(".00","")
                    .trim();
        ...
        holder.intTr = dataStore.get(position).getTreatment().size();
        holder.strPhone = dataStore.get(position).getPhoneStore();
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                b.putInt("intTr", holder.intTr);
                b.putString("strPhone", holder.strPhone);
                intent.putExtras(b);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView imgOutlet;
        String strIdStore, strIdUser, strLat, strLong, linkPhoto, strPhone;
        int intTr;
